...
track("purchase", { value: 49, currency: "USD" });`;
  ...
  return (
    <div className="space-y-6 relative min-h-[calc(100vh-160px)] flex flex-col justify-between">
      
      {/* Top Header - Aligned with strict page width rules */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5 text-xs font-mono">
          <span className={`px-3 py-1 rounded-xl transition-colors ${step === 1 ? "bg-[#800E13] text-white font-bold" : "bg-[#262626] text-zinc-400"}`}>
            1. Website
          </span>
          <span className="text-zinc-600">→</span>
          <span className={`px-3 py-1 rounded-xl transition-colors ${step === 2 ? "bg-[#800E13] text-white font-bold" : "bg-[#262626] text-zinc-400"}`}>
            2. Script
          </span>
        </div>
      </div>

      {/* Main Content Area with World Map Background */}
      <div className="relative flex-1 flex items-center justify-center py-8">
        
        {/* World Map Background strictly spanning container */}
        <WorldMapBackground />
